...
function heal(maxHp, currentHp, healAmount) {
  if (currentHp === maxHp) {
    return currentHp;
  } else if (currentHp + healAmount > maxHp) {
    let maximumLeftPointsToAdd = maxHp - currentHp;
    return currentHp + maximumLeftPointsToAdd;
  } else {
...
function canSee(light, vision) {
  if (light === "bright") {
    return true;
  } else if ((light === "dim" || light === "dark") && vision === "dark") {
    return true;
  } else {
    return false;
  }
